...
parser.add_argument('--val_path', type=str, default='./data/val', help='the path of val data')
parser.add_argument('--save_path', type=str, default='./checkpoint', help='the path of save_model')
...
parser.add_argument('--batch_size', type = int, default=1, help = 'the batch_size of training size')
...
for epoch_num in tqdm(range(max_epoch), ncols=70):
    ...
    for i, sampled_batch in enumerate(zip(labeled_dataloader, cycle(weak_dataloader))):
        ...
        #迭代1k保存模型
        if iter_num % 1000 == 0:
            save_mode_path = os.path.join(args.save_path, 'iter_' + str(iter_num) + '.pth')
